...
[Анализ структуры страницы](//2_analyze.txt)
...
[Оригинал](//image/3_before.png)
[Изменения с помощью разработчика](//image/3_after.png)
...
[Прототип низкой детализации](//image/4_photo.png)
